      ...
      {mode === 'chat' && (
        ...
        >
          {!chatHasMessages ? (
            ...
            /* ── Landing state ── */
            <div className="flex flex-col items-center justify-center flex-1 gap-7 px-4">
                    ...
                    <div className="relative">
                      {chatImportedCase ? (
                        ...
                        <button
                          ...
                          className="w-8 h-8 rounded-xl border border-slate-200 hover:border-slate-300 flex items-center justify-center text-slate-500 hover:text-slate-700 transition-all text-lg leading-none"
                        >+</button>
                      )}
